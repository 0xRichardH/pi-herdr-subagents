...
4. Delegate independent reconnaissance, implementation, or review when it reduces risk or wall-clock time. Do not delegate overlapping edits to the same files.
